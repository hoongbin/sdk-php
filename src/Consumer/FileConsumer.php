 ...
 */
class BetaData_Consumer_FileConsumer extends BetaData_Consumer_AbstractConsumer
{
    /**
    ...
    function __construct($options)
    {
        ...
        $this->_file = array_key_exists("file", $options) ? $options['file'] :  dirname(__FILE__)."/../../betadata.log";
    }
